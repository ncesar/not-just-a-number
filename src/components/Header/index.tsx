    ...
    <HeaderWrapper>
      ...
      <TextWrapper>
        <p>
          ...
          , um número que desafia a compreensão humana. Este site foi criado com
          o objetivo de ajudar os visitantes a entenderem a{' '}
        ...
        <p>
          <strong>
            Todas as imagens utilizadas neste site foram geradas por um
            computador e nenhuma delas existe ou já existiu como ser humano.{' '}
          </strong>
          Elas foram geradas de forma aleatória, sem seguir nenhuma regra de
          cor, gênero ou qualquer outra condição. Saiba mais da inspiração para
          a criação deste site e como ele foi criado{' '}
          <Link to="/about">clicando aqui.</Link>
        </p>
        <p>
          Conforme você for rolando a página para baixo,{' '}
          <strong>tente suspender sua descrença</strong> em pensar que são
          apenas imagens virtuais e considere cada pessoa como real e o
          significado que ela pode ter simbolizado - a vida em que viveram, a
          maneira como morreram e a família que deixaram para trás.
        </p>
      </TextWrapper>
    </HeaderWrapper>
  );
