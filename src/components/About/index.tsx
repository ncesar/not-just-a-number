    ...
    <AboutWrapper>
      ...
      <TextWrapper>
        <p>
          ...
          que seja visível intelectualmente que cada um desses números
          representa uma pessoa real, é absolutamente impossível compreender
          completamente o dano que o COVID-19 vem causando.
        </p>
        <p>
          Um memorial que nomeie todos os mortos, como os criados após a Guerra
          do Vietnã e o 11 de setembro, nunca será possível para o COVID. Muitos
          morreram sozinhos em casa, sem nem ao menos terem sido testados. Os
          registros de óbito do governo fornecem dados incompletos e os
          resultados dos testes de laboratório são anônimos ao público em sua
          grande parte.
        </p>
        <p>
          Como podemos lamentar a morte de pessoas cujos rostos nunca veremos e
          cujos nomes nunca vamos ouvir? Como podemos compreender a escala
          disso?
        </p>
        <p>
      ...
      <TextWrapper>
        <p>
          ...
          ajudar por que{' '}
          <strong>
            pessoas próximas de mim sabem o poder devastador que o COVID-19 tem,
            e consequentemente, eu também.
          </strong>
        </p>
        <p>
          O meu nome é César Nascimento, tenho 22 anos, sou estudante de Ciência
          da Computação e sou apaixonado em criar projetos fora do meu horário
          de trabalho. Eu também crio vídeos para o YouTube de programação no{' '}
          <a
